...
export default hopeTheme(
  {
    ...
    copyright:
      '<a href="/docs/legal.html" target="_blank">Copyright © heStudio 2021-2024</a>',
    ...
    locales: {
      "/": {
        ...
        footer:
          '<p><a href="https://beian.miit.gov.cn" target="_blank">鲁ICP备2023019014号-1</a></p><p><a href="https://status.hestudio.net" target="_blank">本站支持 IPV6 访问</a></p>',
